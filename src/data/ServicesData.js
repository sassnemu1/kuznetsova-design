...
export function getAdjacentWorks(slug) {
  const allWorks = SERVICES_DATA.flatMap((s) =>
    s.works.map((w) => ({
      ...w,
      serviceTag: s.tag,
