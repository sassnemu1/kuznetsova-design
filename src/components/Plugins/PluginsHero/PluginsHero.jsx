...
const STATS = [
  { num: `${totalModules}`, label: "модулей" },
  { num: `${liveModules}`, label: "уже работают" },
  { num: `${totalIndustries}`, label: "отраслей" },
];
    ...
    <section ref={sectionRef} className={`${styles.hero} nav-dark-zone`}>
      ...
      <div ref={topBarRef} className={styles.topBar}>
        ...
        <span className={styles.issue}>
          ...
          <span className={styles.issueLabel}>dash · в разработке</span>
        </span>
      </div>
      ...
      <div className={styles.bottom}>
        ...
        <div ref={bottomRef} className={styles.bottomContent}>
          <p className={styles.desc}>
            Сайт приводит клиента, но работа начинается дальше: заявки, записи,
            заказы, остатки и деньги. Плагин — это дашборд, собранный под вашу
            отрасль и живущий в вашем собственном кабинете, а не в чужой
